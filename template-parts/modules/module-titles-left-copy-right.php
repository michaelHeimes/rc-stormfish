...
<section class="titles-left-copy-right module position-relative position-relative bg-ultra-blue layout-<?php if( empty($eyebrow_title) ) { echo 'no-eyebrow has-bg'; };?>
